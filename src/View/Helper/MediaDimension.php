...
class MediaDimension extends AbstractHelper
{
     ...
     *
     * @param \Omeka\Api\Representation\MediaRepresentation|\Omeka\Entity\Media|string $media Can be a media, an url or a filepath.
    ...
    {
        try {
            return $this->mediaDimensionPlugin->__invoke($media, $type);
